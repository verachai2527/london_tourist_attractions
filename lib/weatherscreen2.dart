...
class WeatherAPI2 extends StatefulWidget {
  const WeatherAPI2({Key? key}) : super(key: key);

  @override
  State<WeatherAPI2> createState() => _WeatherAPI2State();
}

class _WeatherAPI2State extends State<WeatherAPI2> {
  String key = 'bdc31733796dbbeb750ad9bce5d73668';
